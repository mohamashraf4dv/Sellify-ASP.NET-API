...
//        public AuthRepository(SellifyMicrosoftSqlContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration, ILogger<AuthenticationRepository> logger)
//        {
...
//            {
//                string jwtToken = await CreateJwtToken(applicationUser);
...
//        }
//        private async Task<string> CreateJwtToken(ApplicationUser applicationUser, bool isPersistence = false)
//        {
//            ///--- Expiration Date ---///
