...
namespace Sellify.Infrastructure.Migrations
{
    ...
    [Migration("20260413023328_added-payment-session")]
    partial class addedpaymentsession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sellify.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Sellify.Domain.Entities.PaymentSession", b =>
                {
            ...
            modelBuilder.Entity("Sellify.Domain.Entities.UserWishlistProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sellify.Infrastructure.IdentityUserModel.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("SellerRoleRequestStatus")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Sellify.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("Sellify.Domain.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Sellify.Domain.Entities.Token", b =>
                {
                    b.HasOne("Sellify.Infrastructure.IdentityUserModel.ApplicationUser", null)
                        .WithOne("Token")
                        .HasForeignKey("Sellify.Domain.Entities.Token", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
